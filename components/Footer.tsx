...
const Footer = () => {
  return (
    <div className="bg-[#1C1C1C] text-center py-10 text-darkText ring-4 shadow-glow">
      <p className="text-darkAccent">Reach out: info@example.com | Follow us for more cosmic updates.</p>
      <p>“© 2024 Exploring the universe, one discovery at a time.”</p>
      Connect me:
      <Link
        href="https://www.linkedin.com/in/suhaib1/"
        target="_blank"
        rel="noopener noreferrer"
        className="underline bg-transparent shadow-md text-darkAccent shadow-darkShadow hover:text-darkAccent"
      >
        Linkedin
      </Link>
    </div>
